...
# 4 Tank için Kurumsal Pastel Renk Paleti (Açık Dolgu & Uyumlu Yazı)
TANK_RENKLERI = {
    "T40": {"fill": "E2EFDA", "font": "276A3C"},  # Soft Yeşil
    "T41": {"fill": "DDEBF7", "font": "1B4E75"},  # Soft Mavi
    "T42": {"fill": "FFF2CC", "font": "806000"},  # Soft Sarı
    "T43": {"fill": "FCE4D6", "font": "A61C1C"},  # Soft Turuncu / Gül
}
...
def gunluk_tank_hazirligi_v80(
    ...
    # Tankları CIP bitiş zamanına göre sırala
    sorted_tanks = sorted(
        tank_list,
...
if uploaded_file is not None:
    if st.button("🚀 Çizelgeyi Oluştur ve Analiz Et", type="primary"):
        with st.spinner("Matematiksel kısıtlar ve çizelge hesaplanıyor..."):
            results = run_scheduler_pipeline(uploaded_file)
